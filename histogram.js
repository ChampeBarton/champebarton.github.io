...
function drawHistogram(){
  ...
  // d3.csv("master.csv", function(error, masterData) {
    d3.csv("https://www.champebarton.github.io/genre_mapping.csv", function(error, genreMapping) {
      d3.csv("https://www.champebarton.github.io/character_list7.csv", function(error, characterData) {
        d3.csv("https://raw.githubusercontent.com/matthewfdaniels/scripts/graphs/meta_data7.csv", function(error, metaData) {
           d3.csv("https://www.champebarton.github.io/DisneyFilms3.csv", function(error, disneyFilms) {
